 ...
 */
class ExampleServerTest extends SpecBase with ScalatestRouteTest {

  "The server" must {
    "handle a GET on /status and return a positive uptime in milliseconds" in new ExampleServer {
